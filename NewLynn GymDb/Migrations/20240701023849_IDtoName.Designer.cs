...
namespace NewLynn_GymDb.Migrations
{
    ...
    [Migration("20240701023849_IDtoName")]
    partial class IDtoName
    {
            ...
            modelBuilder.Entity("NewLynn_GymDb.Models.Attendance", b =>
                {
                    b.HasOne("NewLynn_GymDb.Models.Employee", "Employee")
                        .WithOne("Attendances")
                        .HasForeignKey("NewLynn_GymDb.Models.Attendance", "EmployeeID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("NewLynn_GymDb.Models.Transaction", b =>
                {
                    b.HasOne("NewLynn_GymDb.Models.Employee", "Employee")
                        ...
                        .HasForeignKey("NewLynn_GymDb.Models.Transaction", "EmployeeID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NewLynn_GymDb.Models.Member", "Member")
                        .WithOne("Transactions")
                        .HasForeignKey("NewLynn_GymDb.Models.Transaction", "MemberID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
